...
<html>
	...
	<body>
		<form action="<%=path%>/role/lyList" method="post" id="form1" name="form1">
						...
						<div class="panel-body">
							<div class="table-responsive">
								...
								<div class="dataTables_filter">
									<label>
										楼宇名称：<input name="s_role_name" id="s_role_name" value="${pageBean.paramMap.s_role_name }"type="search" class="" placeholder="" aria-controls="data-table"/>
										<a class="btn btn-success btn-sm" href="javascript:$('#form1').submit();"><i class="fa fa-search"></i> </a>
									</label>
								</div>

								<p>
									<a class="btn btn-sm btn-success" href="<%=path%>/view/system/lyxx/edit.jsp"><i class="fa fa-plus"></i> 添加</a>
										...
										<c:forEach items="${pageBean.list }" var="v" varStatus="s">
											<tr>
												...
												<td>
													...
													<a href="<%=path %>/role/toUpdateLy?id=${v.id }"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
												</td>
											</tr>
										</c:forEach>
