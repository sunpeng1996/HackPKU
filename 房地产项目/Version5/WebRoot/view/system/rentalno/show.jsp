...
<html>
	...
	<body>
		<form action="<%=path%>/rental/rentalnoList" method="post" id="form1" name="form1">
					...
					<div class="panel panel-inverse">
						...
						<div class="panel-body">
							<div class="table-responsive">
								...
								<p>
									<a class="btn btn-sm btn-success" href="<%=path%>/view/system/rentalno/edit.jsp"><i class="fa fa-plus"></i> 添加</a>
										...
										<c:forEach items="${pageBean.list }" var="v" varStatus="s">
											<tr>
												...
												<td>
													...
													<a href="<%=path %>/rental/toUpdateRentalno?id=${v.id }"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
												</td>
											</tr>
										</c:forEach>
