...
<html>
	...
	<script type="text/javascript">
			function tj(){
				...
				var ei=0;
				if($("#jgmc").val().trim()==''){
					ei++;errorstr=errorstr+ei+'.税务机关名称不能为空\n';
				}
				...
				if(errorstr.length==0){
					$.ajax({type : "POST",  
				       url : "<%=path%>/role/editSwjg",   
				       data:$('#form1').serialize(),
				       success : function (data){  
				           if(data=="notOk"){
				        	   alert("系统错误，请联系管理员!");
				           }else{
				           	  window.location.href="<%=path%>/role/swjgList";
				           }
				       }  
					});
				}
			    ...
			    <div class="col-md-7" style="width: 100%;">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        <div class="panel-heading">
							<h4 class="panel-title">税务机关信息管理</h4>
						</div>
                        <div class="panel-body" style="margin-right:30%">
                           
                                <div class="form-group">
                                    <label class="col-md-3 control-label"><span style="color: red">*</span> 税务机关名称：</label>
                                    <div class="col-md-9">
                                        <input type="text" name="jgmc" id="jgmc" value="${map.jgmc }"class="form-control"  style="width: 60%;"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                    	...
                                    	<a class="btn btn-sm btn-success" href="<%=path %>/role/swjgList"><i class="fa "></i>返回</a>
                                    </div>
                                </div>
