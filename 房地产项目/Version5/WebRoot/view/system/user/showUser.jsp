						...
						<div class="panel-body">
							<div class="table-responsive">
								...
								<div class="dataTables_filter">
									<label>
										用户姓名：<input name="s_user_name" id="s_user_name" value="${pageBean.paramMap.s_user_name }"type="search" class="" placeholder="" aria-controls="data-table"/>
										<a class="btn btn-success btn-sm" href="javascript:$('#form1').submit();"><i class="fa fa-search"></i> </a>
									</label>
								</div>

								<p>
									<a class="btn btn-sm btn-success" href="<%=path%>/view/system/user/editUser.jsp"><i class="fa fa-plus"></i> 添加</a>
										...
										<c:forEach items="${pageBean.list }" var="v" varStatus="s">
											<tr>
												...
												<td>
													...
													<a href="<%=path %>/user/toUpdateUser?id=${v.id }"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
