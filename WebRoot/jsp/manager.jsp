        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="javascript:load('signup.html');"><i class="fa fa-dashboard"></i>个人信息</a>
                    </li>
                    <li>
                        <a href="javascript:load('signup.html');"><i class="fa fa-desktop"></i>认证</a>
                    </li>
					<li>
                        <a href="javascript:load('chart.html');"><i class="fa fa-bar-chart-o"></i>
                            我的社团</a>
                    </li>
                    <li>
